...
local base06 = "#bab696" -- +++
local base07 = "#f8f5de" -- ++++
local base08 = "#e35142" -- red
local base09 = "#fba11b" -- orange
local base0A = "#f2ff27" -- yellow
local base0B = "#5ceb5a" -- green
local base0C = "#5aebbc" -- aqua/cyan
local base0D = "#489bf0" -- blue
local base0E = "#FF8080" -- purple
local base0F = "#F69BE7" -- brown
