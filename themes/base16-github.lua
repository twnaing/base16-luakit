...
local base06 = "#ffffff" -- +++
local base07 = "#ffffff" -- ++++
local base08 = "#ed6a43" -- red
local base09 = "#0086b3" -- orange
local base0A = "#795da3" -- yellow
local base0B = "#183691" -- green
local base0C = "#183691" -- aqua/cyan
local base0D = "#795da3" -- blue
local base0E = "#a71d5d" -- purple
local base0F = "#333333" -- brown
