...
local base06 = "#302C2D" -- +++
local base07 = "#201C1D" -- ++++
local base08 = "#F7939B" -- red
local base09 = "#F6661E" -- orange
local base0A = "#FBE0D9" -- yellow
local base0B = "#94E1B0" -- green
local base0C = "#DC3318" -- aqua/cyan
local base0D = "#DA103F" -- blue
local base0E = "#1D8991" -- purple
local base0F = "#E58C92" -- brown
