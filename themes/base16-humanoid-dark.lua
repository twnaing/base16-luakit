...
local base06 = "#fcfcf6" -- +++
local base07 = "#fcfcfc" -- ++++
local base08 = "#f11235" -- red
local base09 = "#ff9505" -- orange
local base0A = "#ffb627" -- yellow
local base0B = "#02d849" -- green
local base0C = "#0dd9d6" -- aqua/cyan
local base0D = "#00a6fb" -- blue
local base0E = "#f15ee3" -- purple
