...
local base06 = "#E0E0FF" -- +++
local base07 = "#F5F5FF" -- ++++
local base08 = "#FF4242" -- red
local base09 = "#FC8D28" -- orange
local base0A = "#F3E877" -- yellow
local base0B = "#59F176" -- green
local base0C = "#0EF0F0" -- aqua/cyan
local base0D = "#66B0FF" -- blue
local base0E = "#F10596" -- purple
local base0F = "#F003EF" -- brown
