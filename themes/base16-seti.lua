...
local base06 = "#eeeeee" -- +++
local base07 = "#ffffff" -- ++++
local base08 = "#Cd3f45" -- red
local base09 = "#db7b55" -- orange
local base0A = "#e6cd69" -- yellow
local base0B = "#9fca56" -- green
local base0C = "#55dbbe" -- aqua/cyan
local base0D = "#55b5db" -- blue
local base0E = "#a074c4" -- purple
local base0F = "#8a553f" -- brown
