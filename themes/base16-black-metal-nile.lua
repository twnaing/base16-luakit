...
local base09 = "#aaaaaa" -- orange
local base0A = "#777755" -- yellow
local base0B = "#aa9988" -- green
local base0C = "#aaaaaa" -- aqua/cyan
local base0D = "#888888" -- blue
local base0E = "#999999" -- purple
local base0F = "#444444" -- brown
