...
local base06 = "#2c3138" -- +++
local base07 = "#181c22" -- ++++
local base08 = "#d02023" -- red
local base09 = "#bf3e05" -- orange
local base0A = "#9d6f00" -- yellow
local base0B = "#637200" -- green
local base0C = "#007a72" -- aqua/cyan
local base0D = "#0073b5" -- blue
local base0E = "#4e66b6" -- purple
local base0F = "#c42775" -- brown
