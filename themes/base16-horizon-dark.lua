...
local base06 = "#DCDFE4" -- +++
local base07 = "#E3E6EE" -- ++++
local base08 = "#E93C58" -- red
local base09 = "#E58D7D" -- orange
local base0A = "#EFB993" -- yellow
local base0B = "#EFAF8E" -- green
local base0C = "#24A8B4" -- aqua/cyan
local base0D = "#DF5273" -- blue
local base0E = "#B072D1" -- purple
local base0F = "#E4A382" -- brown
