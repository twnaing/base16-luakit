...
local base06 = "#c2c3c7" -- +++
local base07 = "#fff1e8" -- ++++
local base08 = "#ff004d" -- red
local base09 = "#ffa300" -- orange
local base0A = "#fff024" -- yellow
local base0B = "#00e756" -- green
local base0C = "#29adff" -- aqua/cyan
local base0D = "#83769c" -- blue
local base0E = "#ff77a8" -- purple
local base0F = "#ffccaa" -- brown
