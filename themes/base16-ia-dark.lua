...
local base06 = "#e8e8e8" -- +++
local base07 = "#f8f8f8" -- ++++
local base08 = "#d88568" -- red
local base09 = "#d86868" -- orange
local base0A = "#b99353" -- yellow
local base0B = "#83a471" -- green
local base0C = "#7c9cae" -- aqua/cyan
local base0D = "#8eccdd" -- blue
local base0E = "#b98eb2" -- purple
