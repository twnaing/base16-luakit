...
local base06 = "#c1e4f6" -- +++
local base07 = "#ebf8ff" -- ++++
local base08 = "#d22d72" -- red
local base09 = "#935c25" -- orange
local base0A = "#8a8a0f" -- yellow
local base0B = "#568c3b" -- green
local base0C = "#2d8f6f" -- aqua/cyan
local base0D = "#257fad" -- blue
local base0E = "#6b6bb8" -- purple
local base0F = "#b72dd2" -- brown
