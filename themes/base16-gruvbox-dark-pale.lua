...
local base06 = "#d5c4a1" -- +++
local base07 = "#ebdbb2" -- ++++
local base08 = "#d75f5f" -- red
local base09 = "#ff8700" -- orange
local base0A = "#ffaf00" -- yellow
local base0B = "#afaf00" -- green
local base0C = "#85ad85" -- aqua/cyan
local base0D = "#83adad" -- blue
local base0E = "#d485ad" -- purple
