...
local base06 = "#293256" -- +++
local base07 = "#202746" -- ++++
local base08 = "#c94922" -- red
local base09 = "#c76b29" -- orange
local base0A = "#c08b30" -- yellow
local base0B = "#ac9739" -- green
local base0C = "#22a2c9" -- aqua/cyan
local base0D = "#3d8fd1" -- blue
local base0E = "#6679cc" -- purple
local base0F = "#9c637a" -- brown
