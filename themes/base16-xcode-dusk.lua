...
local base06 = "#A9AAAE" -- +++
local base07 = "#BEBFC2" -- ++++
local base08 = "#B21889" -- red
local base09 = "#786DC5" -- orange
local base0A = "#438288" -- yellow
local base0B = "#DF0002" -- green
local base0C = "#00A0BE" -- aqua/cyan
local base0D = "#790EAD" -- blue
local base0E = "#B21889" -- purple
local base0F = "#C77C48" -- brown
