...
local base06 = "#d390e7" -- +++
local base07 = "#3e4249" -- ++++
local base08 = "#e77171" -- red
local base09 = "#e77171" -- orange
local base0A = "#dbb774" -- yellow
local base0B = "#a1bf78" -- green
local base0C = "#5ebaa5" -- aqua/cyan
local base0D = "#73b3e7" -- blue
local base0E = "#d390e7" -- purple
local base0F = "#5ebaa5" -- brown
