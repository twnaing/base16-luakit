...
local base06 = "#e3e3e3" -- +++
local base07 = "#f7f7f7" -- ++++
local base08 = "#7c7c7c" -- red
local base09 = "#999999" -- orange
local base0A = "#a0a0a0" -- yellow
local base0B = "#8e8e8e" -- green
local base0C = "#868686" -- aqua/cyan
local base0D = "#686868" -- blue
local base0E = "#747474" -- purple
local base0F = "#5e5e5e" -- brown
