...
local base09 = "#bdb6c5" -- orange
local base0A = "#5ba2b6" -- yellow
local base0B = "#f80059" -- green
local base0C = "#c33678" -- aqua/cyan
local base0D = "#47f9f5" -- blue
local base0E = "#bd0152" -- purple
local base0F = "#dedae2" -- brown
