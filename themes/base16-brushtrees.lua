...
local base06 = "#5A6D7A" -- +++
local base07 = "#485867" -- ++++
local base08 = "#b38686" -- red
local base09 = "#d8bba2" -- orange
local base0A = "#aab386" -- yellow
local base0B = "#87b386" -- green
local base0C = "#86b3b3" -- aqua/cyan
local base0D = "#868cb3" -- blue
local base0E = "#b386b2" -- purple
local base0F = "#b39f9f" -- brown
