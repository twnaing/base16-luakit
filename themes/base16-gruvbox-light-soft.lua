...
local base06 = "#3c3836" -- +++
local base07 = "#282828" -- ++++
local base08 = "#9d0006" -- red
local base09 = "#af3a03" -- orange
local base0A = "#b57614" -- yellow
local base0B = "#79740e" -- green
local base0C = "#427b58" -- aqua/cyan
local base0D = "#076678" -- blue
local base0E = "#8f3f71" -- purple
