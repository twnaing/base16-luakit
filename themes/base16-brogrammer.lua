...
local base06 = "#1081d6" -- +++
local base07 = "#d6dbe5" -- ++++
local base08 = "#d6dbe5" -- red
local base09 = "#de352e" -- orange
local base0A = "#1dd361" -- yellow
local base0B = "#f3bd09" -- green
local base0C = "#1081d6" -- aqua/cyan
local base0D = "#5350b9" -- blue
local base0E = "#0f7ddb" -- purple
local base0F = "#ffffff" -- brown
