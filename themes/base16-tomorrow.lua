...
local base06 = "#282a2e" -- +++
local base07 = "#1d1f21" -- ++++
local base08 = "#c82829" -- red
local base09 = "#f5871f" -- orange
local base0A = "#eab700" -- yellow
local base0B = "#718c00" -- green
local base0C = "#3e999f" -- aqua/cyan
local base0D = "#4271ae" -- blue
local base0E = "#8959a8" -- purple
local base0F = "#a3685a" -- brown
