...
local base06 = "#f5f5f5" -- +++
local base07 = "#ffffff" -- ++++
local base08 = "#fb0120" -- red
local base09 = "#fc6d24" -- orange
local base0A = "#fda331" -- yellow
local base0B = "#a1c659" -- green
local base0C = "#76c7b7" -- aqua/cyan
local base0D = "#6fb3d2" -- blue
local base0E = "#d381c3" -- purple
