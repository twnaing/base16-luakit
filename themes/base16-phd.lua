...
local base06 = "#dbdde0" -- +++
local base07 = "#ffffff" -- ++++
local base08 = "#d07346" -- red
local base09 = "#f0a000" -- orange
local base0A = "#fbd461" -- yellow
local base0B = "#99bf52" -- green
local base0C = "#72b9bf" -- aqua/cyan
local base0D = "#5299bf" -- blue
local base0E = "#9989cc" -- purple
local base0F = "#b08060" -- brown
