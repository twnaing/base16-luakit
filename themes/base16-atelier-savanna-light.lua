...
local base06 = "#232a25" -- +++
local base07 = "#171c19" -- ++++
local base08 = "#b16139" -- red
local base09 = "#9f713c" -- orange
local base0A = "#a07e3b" -- yellow
local base0B = "#489963" -- green
local base0C = "#1c9aa0" -- aqua/cyan
local base0D = "#478c90" -- blue
local base0E = "#55859b" -- purple
local base0F = "#867469" -- brown
