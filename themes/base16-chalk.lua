...
local base06 = "#e0e0e0" -- +++
local base07 = "#f5f5f5" -- ++++
local base08 = "#fb9fb1" -- red
local base09 = "#eda987" -- orange
local base0A = "#ddb26f" -- yellow
local base0B = "#acc267" -- green
local base0C = "#12cfc0" -- aqua/cyan
local base0D = "#6fc2ef" -- blue
local base0E = "#e1a3ee" -- purple
local base0F = "#deaf8f" -- brown
