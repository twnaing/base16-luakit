...
local base06 = "#DCDFE4" -- +++
local base07 = "#E3E6EE" -- ++++
local base08 = "#E95678" -- red
local base09 = "#FAB795" -- orange
local base0A = "#FAC29A" -- yellow
local base0B = "#29D398" -- green
local base0C = "#59E1E3" -- aqua/cyan
local base0D = "#26BBD9" -- blue
local base0E = "#EE64AC" -- purple
local base0F = "#F09383" -- brown
