...
local base06 = "#EFEBEF" -- +++
local base07 = "#FFFBFF" -- ++++
local base08 = "#B53B50" -- red
local base09 = "#E4600E" -- orange
local base0A = "#DAE84D" -- yellow
local base0B = "#06EA61" -- green
local base0C = "#7CEDE9" -- aqua/cyan
local base0D = "#03AEFF" -- blue
local base0E = "#EA5CE2" -- purple
local base0F = "#9D4D0E" -- brown
