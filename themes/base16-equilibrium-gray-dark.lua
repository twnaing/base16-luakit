...
local base06 = "#c6c6c6" -- +++
local base07 = "#e2e2e2" -- ++++
local base08 = "#f04339" -- red
local base09 = "#df5923" -- orange
local base0A = "#bb8801" -- yellow
local base0B = "#7f8b00" -- green
local base0C = "#00948b" -- aqua/cyan
local base0D = "#008dd1" -- blue
local base0E = "#6a7fd2" -- purple
local base0F = "#e3488e" -- brown
