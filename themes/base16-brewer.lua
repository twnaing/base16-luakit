...
local base06 = "#dadbdc" -- +++
local base07 = "#fcfdfe" -- ++++
local base08 = "#e31a1c" -- red
local base09 = "#e6550d" -- orange
local base0A = "#dca060" -- yellow
local base0B = "#31a354" -- green
local base0C = "#80b1d3" -- aqua/cyan
local base0D = "#3182bd" -- blue
local base0E = "#756bb1" -- purple
local base0F = "#b15928" -- brown
