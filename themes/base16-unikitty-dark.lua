...
local base06 = "#d8d7da" -- +++
local base07 = "#f5f4f7" -- ++++
local base08 = "#d8137f" -- red
local base09 = "#d65407" -- orange
local base0A = "#dc8a0e" -- yellow
local base0B = "#17ad98" -- green
local base0C = "#149bda" -- aqua/cyan
local base0D = "#796af5" -- blue
local base0E = "#bb60ea" -- purple
local base0F = "#c720ca" -- brown
