...
local base06 = "#72677E" -- +++
local base07 = "#585062" -- ++++
local base08 = "#D57E85" -- red
local base09 = "#EBB790" -- orange
local base0A = "#DCB16C" -- yellow
local base0B = "#A3B367" -- green
local base0C = "#69A9A7" -- aqua/cyan
local base0D = "#7297B9" -- blue
local base0E = "#BB99B4" -- purple
local base0F = "#BAA58C" -- brown
