...
local base06 = "#e8e8e8" -- +++
local base07 = "#f8f8f8" -- ++++
local base08 = "#f2241f" -- red
local base09 = "#ffa500" -- orange
local base0A = "#b1951d" -- yellow
local base0B = "#67b11d" -- green
local base0C = "#2d9574" -- aqua/cyan
local base0D = "#4f97d7" -- blue
local base0E = "#a31db1" -- purple
local base0F = "#b03060" -- brown
