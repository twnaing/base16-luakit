...
local base09 = "#EA9560" -- orange
local base0A = "#FFCC00" -- yellow
local base0B = "#8BD649" -- green
local base0C = "#80CBC4" -- aqua/cyan
local base0D = "#89DDFF" -- blue
local base0E = "#82AAFF" -- purple
local base0F = "#EC5F67" -- brown
