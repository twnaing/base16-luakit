...
local base06 = "#404040" -- +++
local base07 = "#5e5e5e" -- ++++
local base08 = "#c41a15" -- red
local base09 = "#eb8500" -- orange
local base0A = "#826b28" -- yellow
local base0B = "#007400" -- green
local base0C = "#318495" -- aqua/cyan
local base0D = "#0000ff" -- blue
local base0E = "#a90d91" -- purple
local base0F = "#826b28" -- brown
