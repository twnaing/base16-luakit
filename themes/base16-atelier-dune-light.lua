...
local base06 = "#292824" -- +++
local base07 = "#20201d" -- ++++
local base08 = "#d73737" -- red
local base09 = "#b65611" -- orange
local base0A = "#ae9513" -- yellow
local base0B = "#60ac39" -- green
local base0C = "#1fad83" -- aqua/cyan
local base0D = "#6684e1" -- blue
local base0E = "#b854d4" -- purple
local base0F = "#d43552" -- brown
