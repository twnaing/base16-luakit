...
local base06 = "#899BA6" -- +++
local base07 = "#556873" -- ++++
local base08 = "#83AFE5" -- red
local base09 = "#7FC1CA" -- orange
local base0A = "#A8CE93" -- yellow
local base0B = "#7FC1CA" -- green
local base0C = "#F2C38F" -- aqua/cyan
local base0D = "#83AFE5" -- blue
local base0E = "#9A93E1" -- purple
local base0F = "#F2C38F" -- brown
