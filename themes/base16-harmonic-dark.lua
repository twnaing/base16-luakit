...
local base06 = "#e5ebf1" -- +++
local base07 = "#f7f9fb" -- ++++
local base08 = "#bf8b56" -- red
local base09 = "#bfbf56" -- orange
local base0A = "#8bbf56" -- yellow
local base0B = "#56bf8b" -- green
local base0C = "#568bbf" -- aqua/cyan
local base0D = "#8b56bf" -- blue
local base0E = "#bf568b" -- purple
local base0F = "#bf5656" -- brown
