...
local base06 = "#808080" -- +++
local base07 = "#ffffff" -- ++++
local base08 = "#dc657d" -- red
local base09 = "#4bb1a7" -- orange
local base0A = "#c3ba63" -- yellow
local base0B = "#84b97c" -- green
local base0C = "#4bb1a7" -- aqua/cyan
local base0D = "#639ee4" -- blue
local base0E = "#b888e2" -- purple
local base0F = "#b888e2" -- brown
