...
local base06 = "#2c2421" -- +++
local base07 = "#1b1918" -- ++++
local base08 = "#f22c40" -- red
local base09 = "#df5320" -- orange
local base0A = "#c38418" -- yellow
local base0B = "#7b9726" -- green
local base0C = "#3d97b8" -- aqua/cyan
local base0D = "#407ee7" -- blue
local base0E = "#6666ea" -- purple
local base0F = "#c33ff3" -- brown
