...
local base06 = "#eee8d5" -- +++
local base07 = "#fdf6e3" -- ++++
local base08 = "#dc322f" -- red
local base09 = "#cb4b16" -- orange
local base0A = "#b58900" -- yellow
local base0B = "#859900" -- green
local base0C = "#2aa198" -- aqua/cyan
local base0D = "#268bd2" -- blue
local base0E = "#6c71c4" -- purple
local base0F = "#d33682" -- brown
