...
local base06 = "#e0e0e0" -- +++
local base07 = "#ffffff" -- ++++
local base08 = "#d25252" -- red
local base09 = "#f9a959" -- orange
local base0A = "#ffc66d" -- yellow
local base0B = "#a5c261" -- green
local base0C = "#bed6ff" -- aqua/cyan
local base0D = "#6c99bb" -- blue
local base0E = "#d197d9" -- purple
local base0F = "#f97394" -- brown
