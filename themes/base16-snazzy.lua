...
local base06 = "#eff0eb" -- +++
local base07 = "#f1f1f0" -- ++++
local base08 = "#ff5c57" -- red
local base09 = "#ff9f43" -- orange
local base0A = "#f3f99d" -- yellow
local base0B = "#5af78e" -- green
local base0C = "#9aedfe" -- aqua/cyan
local base0D = "#57c7ff" -- blue
local base0E = "#ff6ac1" -- purple
local base0F = "#b2643c" -- brown
