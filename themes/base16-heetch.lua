...
local base06 = "#DEDAE2" -- +++
local base07 = "#FEFFFF" -- ++++
local base08 = "#27D9D5" -- red
local base09 = "#5BA2B6" -- orange
local base0A = "#8F6C97" -- yellow
local base0B = "#C33678" -- green
local base0C = "#F80059" -- aqua/cyan
local base0D = "#BD0152" -- blue
local base0E = "#82034C" -- purple
local base0F = "#470546" -- brown
