...
local base06 = "#202227" -- +++
local base07 = "#090a0b" -- ++++
local base08 = "#ca1243" -- red
local base09 = "#d75f00" -- orange
local base0A = "#c18401" -- yellow
local base0B = "#50a14f" -- green
local base0C = "#0184bc" -- aqua/cyan
local base0D = "#4078f2" -- blue
local base0E = "#a626a4" -- purple
local base0F = "#986801" -- brown
