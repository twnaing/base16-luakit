...
local base06 = "#e5e5e5" -- +++
local base07 = "#ffffff" -- ++++
local base08 = "#f92672" -- red
local base09 = "#fd971f" -- orange
local base0A = "#e6db74" -- yellow
local base0B = "#a6e22e" -- green
local base0C = "#708387" -- aqua/cyan
local base0D = "#66d9ef" -- blue
local base0E = "#9e6ffe" -- purple
local base0F = "#e8b882" -- brown
