...
local base06 = "#CDD3DE" -- +++
local base07 = "#D8DEE9" -- ++++
local base08 = "#EC5f67" -- red
local base09 = "#F99157" -- orange
local base0A = "#FAC863" -- yellow
local base0B = "#99C794" -- green
local base0C = "#5FB3B3" -- aqua/cyan
local base0D = "#6699CC" -- blue
local base0E = "#C594C5" -- purple
local base0F = "#AB7967" -- brown
