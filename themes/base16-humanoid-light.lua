...
local base06 = "#2f3337" -- +++
local base07 = "#070708" -- ++++
local base08 = "#b0151a" -- red
local base09 = "#ff3d00" -- orange
local base0A = "#ffb627" -- yellow
local base0B = "#388e3c" -- green
local base0C = "#008e8e" -- aqua/cyan
local base0D = "#0082c9" -- blue
local base0E = "#700f98" -- purple
local base0F = "#b27701" -- brown
