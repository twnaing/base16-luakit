...
local base06 = "#e7e7e8" -- +++
local base07 = "#ffffff" -- ++++
local base08 = "#ee2e24" -- red
local base09 = "#f386a1" -- orange
local base0A = "#ffd204" -- yellow
local base0B = "#00853e" -- green
local base0C = "#85cebc" -- aqua/cyan
local base0D = "#009ddc" -- blue
local base0E = "#98005d" -- purple
local base0F = "#b06110" -- brown
