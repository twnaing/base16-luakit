...
local base06 = "#292329" -- +++
local base07 = "#1b181b" -- ++++
local base08 = "#ca402b" -- red
local base09 = "#a65926" -- orange
local base0A = "#bb8a35" -- yellow
local base0B = "#918b3b" -- green
local base0C = "#159393" -- aqua/cyan
local base0D = "#516aec" -- blue
local base0E = "#7b59c0" -- purple
local base0F = "#cc33cc" -- brown
