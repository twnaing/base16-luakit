...
local base06 = "#E8E9ED" -- +++
local base07 = "#F5F7FA" -- ++++
local base08 = "#EF5253" -- red
local base09 = "#E66B2B" -- orange
local base0A = "#E4B51C" -- yellow
local base0B = "#7CC844" -- green
local base0C = "#52CBB0" -- aqua/cyan
local base0D = "#33B5E1" -- blue
local base0E = "#A363D5" -- purple
local base0F = "#D73C9A" -- brown
