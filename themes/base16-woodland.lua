...
local base06 = "#d7c8bc" -- +++
local base07 = "#e4d4c8" -- ++++
local base08 = "#d35c5c" -- red
local base09 = "#ca7f32" -- orange
local base0A = "#e0ac16" -- yellow
local base0B = "#b7ba53" -- green
local base0C = "#6eb958" -- aqua/cyan
local base0D = "#88a4d3" -- blue
local base0E = "#bb90e2" -- purple
local base0F = "#b49368" -- brown
