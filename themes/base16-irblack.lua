...
local base06 = "#d9d7cc" -- +++
local base07 = "#fdfbee" -- ++++
local base08 = "#ff6c60" -- red
local base09 = "#e9c062" -- orange
local base0A = "#ffffb6" -- yellow
local base0B = "#a8ff60" -- green
local base0C = "#c6c5fe" -- aqua/cyan
local base0D = "#96cbfe" -- blue
local base0E = "#ff73fd" -- purple
local base0F = "#b18a3d" -- brown
