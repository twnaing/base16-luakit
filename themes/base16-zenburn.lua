...
local base06 = "#c0c0c0" -- +++
local base07 = "#ffffff" -- ++++
local base08 = "#dca3a3" -- red
local base09 = "#dfaf8f" -- orange
local base0A = "#e0cf9f" -- yellow
local base0B = "#5f7f5f" -- green
local base0C = "#93e0e3" -- aqua/cyan
local base0D = "#7cb8bb" -- blue
local base0E = "#dc8cc3" -- purple
local base0F = "#000000" -- brown
