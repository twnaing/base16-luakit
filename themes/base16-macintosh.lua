...
local base06 = "#c0c0c0" -- +++
local base07 = "#ffffff" -- ++++
local base08 = "#dd0907" -- red
local base09 = "#ff6403" -- orange
local base0A = "#fbf305" -- yellow
local base0B = "#1fb714" -- green
local base0C = "#02abea" -- aqua/cyan
local base0D = "#0000d3" -- blue
local base0E = "#4700a5" -- purple
local base0F = "#90713a" -- brown
