...
local base06 = "#e9e1dd" -- +++
local base07 = "#f5eeeb" -- ++++
local base08 = "#cb6077" -- red
local base09 = "#d28b71" -- orange
local base0A = "#f4bc87" -- yellow
local base0B = "#beb55b" -- green
local base0C = "#7bbda4" -- aqua/cyan
local base0D = "#8ab3b5" -- blue
local base0E = "#a89bb9" -- purple
local base0F = "#bb9584" -- brown
