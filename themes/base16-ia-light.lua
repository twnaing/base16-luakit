...
local base06 = "#e8e8e8" -- +++
local base07 = "#f8f8f8" -- ++++
local base08 = "#9c5a02" -- red
local base09 = "#c43e18" -- orange
local base0A = "#c48218" -- yellow
local base0B = "#38781c" -- green
local base0C = "#2d6bb1" -- aqua/cyan
local base0D = "#48bac2" -- blue
local base0E = "#a94598" -- purple
local base0F = "#8b6c37" -- brown
