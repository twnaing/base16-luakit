...
local base06 = "#d6d5d4" -- +++
local base07 = "#f7f7f7" -- ++++
local base08 = "#db2d20" -- red
local base09 = "#e8bbd0" -- orange
local base0A = "#fded02" -- yellow
local base0B = "#01a252" -- green
local base0C = "#b5e4f4" -- aqua/cyan
local base0D = "#01a0e4" -- blue
local base0E = "#a16a94" -- purple
local base0F = "#cdab53" -- brown
