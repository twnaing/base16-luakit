...
local base06 = "#f4f1ed" -- +++
local base07 = "#f9f7f3" -- ++++
local base08 = "#da4939" -- red
local base09 = "#cc7833" -- orange
local base0A = "#ffc66d" -- yellow
local base0B = "#a5c261" -- green
local base0C = "#519f50" -- aqua/cyan
local base0D = "#6d9cbe" -- blue
local base0E = "#b6b3eb" -- purple
local base0F = "#bc9458" -- brown
