...
local base06 = "#b870ce" -- +++
local base07 = "#5e646f" -- ++++
local base08 = "#db7070" -- red
local base09 = "#db7070" -- orange
local base0A = "#d69822" -- yellow
local base0B = "#7c9f4b" -- green
local base0C = "#509c93" -- aqua/cyan
local base0D = "#6587bf" -- blue
local base0E = "#b870ce" -- purple
local base0F = "#509c93" -- brown
