...
local base06 = "#0c7c8c" -- +++
local base07 = "#109cb0" -- ++++
local base08 = "#16c1d9" -- red
local base09 = "#b3ebf2" -- orange
local base0A = "#80deea" -- yellow
local base0B = "#4dd0e1" -- green
local base0C = "#26c6da" -- aqua/cyan
local base0D = "#00bcd4" -- blue
local base0E = "#00acc1" -- purple
local base0F = "#0097a7" -- brown
