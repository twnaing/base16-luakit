...
local base06 = "#a7cfa3" -- +++
local base07 = "#b5d8f6" -- ++++
local base08 = "#2a5491" -- red
local base09 = "#43820d" -- orange
local base0A = "#a03b1e" -- yellow
local base0B = "#237986" -- green
local base0C = "#b02f30" -- aqua/cyan
local base0D = "#484d79" -- blue
local base0E = "#c59820" -- purple
local base0F = "#c98344" -- brown
