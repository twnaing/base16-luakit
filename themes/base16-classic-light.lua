...
local base06 = "#202020" -- +++
local base07 = "#151515" -- ++++
local base08 = "#AC4142" -- red
local base09 = "#D28445" -- orange
local base0A = "#F4BF75" -- yellow
local base0B = "#90A959" -- green
local base0C = "#75B5AA" -- aqua/cyan
local base0D = "#6A9FB5" -- blue
local base0E = "#AA759F" -- purple
local base0F = "#8F5536" -- brown
