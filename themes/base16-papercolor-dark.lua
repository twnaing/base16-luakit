...
local base06 = "#d7875f" -- +++
local base07 = "#d0d0d0" -- ++++
local base08 = "#585858" -- red
local base09 = "#5faf5f" -- orange
local base0A = "#afd700" -- yellow
local base0B = "#af87d7" -- green
local base0C = "#ffaf00" -- aqua/cyan
local base0D = "#ff5faf" -- blue
local base0E = "#00afaf" -- purple
local base0F = "#5f8787" -- brown
