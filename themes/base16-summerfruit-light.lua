...
local base06 = "#151515" -- +++
local base07 = "#202020" -- ++++
local base08 = "#FF0086" -- red
local base09 = "#FD8900" -- orange
local base0A = "#ABA800" -- yellow
local base0B = "#00C918" -- green
local base0C = "#1FAAAA" -- aqua/cyan
local base0D = "#3777E6" -- blue
local base0E = "#AD00A1" -- purple
local base0F = "#CC6633" -- brown
