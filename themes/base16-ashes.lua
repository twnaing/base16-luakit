...
local base06 = "#DFE2E5" -- +++
local base07 = "#F3F4F5" -- ++++
local base08 = "#C7AE95" -- red
local base09 = "#C7C795" -- orange
local base0A = "#AEC795" -- yellow
local base0B = "#95C7AE" -- green
local base0C = "#95AEC7" -- aqua/cyan
local base0D = "#AE95C7" -- blue
local base0E = "#C795AE" -- purple
local base0F = "#C79595" -- brown
