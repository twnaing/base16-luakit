...
local base06 = "#e0e0e0" -- +++
local base07 = "#ffffff" -- ++++
local base08 = "#eb008a" -- red
local base09 = "#f29333" -- orange
local base0A = "#f8ca12" -- yellow
local base0B = "#37b349" -- green
local base0C = "#00aabb" -- aqua/cyan
local base0D = "#0e5a94" -- blue
local base0E = "#b31e8d" -- purple
local base0F = "#7a2d00" -- brown
