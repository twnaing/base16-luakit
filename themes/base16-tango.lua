...
local base06 = "#ad7fa8" -- +++
local base07 = "#eeeeec" -- ++++
local base08 = "#cc0000" -- red
local base09 = "#ef2929" -- orange
local base0A = "#c4a000" -- yellow
local base0B = "#4e9a06" -- green
local base0C = "#06989a" -- aqua/cyan
local base0D = "#3465a4" -- blue
local base0E = "#75507b" -- purple
local base0F = "#34e2e2" -- brown
