...
local base06 = "#d5d3d5" -- +++
local base07 = "#ffffff" -- ++++
local base08 = "#dd464c" -- red
local base09 = "#fd8b19" -- orange
local base0A = "#fdcc59" -- yellow
local base0B = "#8fc13e" -- green
local base0C = "#149b93" -- aqua/cyan
local base0D = "#1290bf" -- blue
local base0E = "#c85e7c" -- purple
local base0F = "#b33508" -- brown
