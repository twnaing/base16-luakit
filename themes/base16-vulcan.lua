...
local base06 = "#333238" -- +++
local base07 = "#214d68" -- ++++
local base08 = "#818591" -- red
local base09 = "#9198a3" -- orange
local base0A = "#adb4b9" -- yellow
local base0B = "#977d7c" -- green
local base0C = "#977d7c" -- aqua/cyan
local base0D = "#977d7c" -- blue
local base0E = "#9198a3" -- purple
local base0F = "#977d7c" -- brown
