...
local base06 = "#b9b6b0" -- +++
local base07 = "#e7e9db" -- ++++
local base08 = "#ef6155" -- red
local base09 = "#f99b15" -- orange
local base0A = "#fec418" -- yellow
local base0B = "#48b685" -- green
local base0C = "#5bc4bf" -- aqua/cyan
local base0D = "#06b6ef" -- blue
local base0E = "#815ba4" -- purple
local base0F = "#e96ba8" -- brown
