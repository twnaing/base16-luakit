...
local base06 = "#e2dfe7" -- +++
local base07 = "#efecf4" -- ++++
local base08 = "#be4678" -- red
local base09 = "#aa573c" -- orange
local base0A = "#a06e3b" -- yellow
local base0B = "#2a9292" -- green
local base0C = "#398bc6" -- aqua/cyan
local base0D = "#576ddb" -- blue
local base0E = "#955ae7" -- purple
local base0F = "#bf40bf" -- brown
