...
local base06 = "#80CBC4" -- +++
local base07 = "#FFFFFF" -- ++++
local base08 = "#FF5370" -- red
local base09 = "#F76D47" -- orange
local base0A = "#FFB62C" -- yellow
local base0B = "#91B859" -- green
local base0C = "#39ADB5" -- aqua/cyan
local base0D = "#6182B8" -- blue
local base0E = "#7C4DFF" -- purple
local base0F = "#E53935" -- brown
