...
local base06 = "#e7e6df" -- +++
local base07 = "#f4f3ec" -- ++++
local base08 = "#ba6236" -- red
local base09 = "#ae7313" -- orange
local base0A = "#a5980d" -- yellow
local base0B = "#7d9726" -- green
local base0C = "#5b9d48" -- aqua/cyan
local base0D = "#36a166" -- blue
local base0E = "#5f9182" -- purple
local base0F = "#9d6c7c" -- brown
