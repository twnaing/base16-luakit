...
local base06 = "#A7CEC8" -- +++
local base07 = "#D2E7E4" -- ++++
local base08 = "#3E9688" -- red
local base09 = "#3E7996" -- orange
local base0A = "#3E4C96" -- yellow
local base0B = "#883E96" -- green
local base0C = "#963E4C" -- aqua/cyan
local base0D = "#96883E" -- blue
local base0E = "#4C963E" -- purple
local base0F = "#3E965B" -- brown
