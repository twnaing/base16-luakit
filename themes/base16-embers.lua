...
local base06 = "#BEB6AE" -- +++
local base07 = "#DBD6D1" -- ++++
local base08 = "#826D57" -- red
local base09 = "#828257" -- orange
local base0A = "#6D8257" -- yellow
local base0B = "#57826D" -- green
local base0C = "#576D82" -- aqua/cyan
local base0D = "#6D5782" -- blue
local base0E = "#82576D" -- purple
local base0F = "#825757" -- brown
