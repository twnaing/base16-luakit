...
local base06 = "#e3e3c8" -- +++
local base07 = "#e1eaef" -- ++++
local base08 = "#ff4658" -- red
local base09 = "#e6db74" -- orange
local base0A = "#fdb11f" -- yellow
local base0B = "#499180" -- green
local base0C = "#66d9ef" -- aqua/cyan
local base0D = "#498091" -- blue
local base0E = "#9bc0c8" -- purple
local base0F = "#d27b53" -- brown
