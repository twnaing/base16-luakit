...
local base06 = "#e8e8e8" -- +++
local base07 = "#f8f8f8" -- ++++
local base08 = "#f84547" -- red
local base09 = "#d28e5d" -- orange
local base0A = "#efa16b" -- yellow
local base0B = "#95c76f" -- green
local base0C = "#64878f" -- aqua/cyan
local base0D = "#8485ce" -- blue
local base0E = "#b74989" -- purple
local base0F = "#986841" -- brown
