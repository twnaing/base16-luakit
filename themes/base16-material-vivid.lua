...
local base06 = "#9e9e9e" -- +++
local base07 = "#ffffff" -- ++++
local base08 = "#f44336" -- red
local base09 = "#ff9800" -- orange
local base0A = "#ffeb3b" -- yellow
local base0B = "#00e676" -- green
local base0C = "#00bcd4" -- aqua/cyan
local base0D = "#2196f3" -- blue
local base0E = "#673ab7" -- purple
local base0F = "#8d6e63" -- brown
