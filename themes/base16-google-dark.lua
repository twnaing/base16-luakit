...
local base06 = "#e0e0e0" -- +++
local base07 = "#ffffff" -- ++++
local base08 = "#CC342B" -- red
local base09 = "#F96A38" -- orange
local base0A = "#FBA922" -- yellow
local base0B = "#198844" -- green
local base0C = "#3971ED" -- aqua/cyan
local base0D = "#3971ED" -- blue
local base0E = "#A36AC7" -- purple
local base0F = "#3971ED" -- brown
