...
local base06 = "#040404" -- +++
local base07 = "#000000" -- ++++
local base08 = "#e92f2f" -- red
local base09 = "#e09448" -- orange
local base0A = "#dddd13" -- yellow
local base0B = "#0ed839" -- green
local base0C = "#23edda" -- aqua/cyan
local base0D = "#3b48e3" -- blue
local base0E = "#f996e2" -- purple
local base0F = "#69542d" -- brown
