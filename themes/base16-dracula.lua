...
local base06 = "#f1f2f8" -- +++
local base07 = "#f7f7fb" -- ++++
local base08 = "#ea51b2" -- red
local base09 = "#b45bcf" -- orange
local base0A = "#00f769" -- yellow
local base0B = "#ebff87" -- green
local base0C = "#a1efe4" -- aqua/cyan
local base0D = "#62d6e8" -- blue
local base0E = "#b45bcf" -- purple
local base0F = "#00f769" -- brown
