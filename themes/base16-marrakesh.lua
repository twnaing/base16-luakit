...
local base06 = "#ccc37a" -- +++
local base07 = "#faf0a5" -- ++++
local base08 = "#c35359" -- red
local base09 = "#b36144" -- orange
local base0A = "#a88339" -- yellow
local base0B = "#18974e" -- green
local base0C = "#75a738" -- aqua/cyan
local base0D = "#477ca1" -- blue
local base0E = "#8868b3" -- purple
local base0F = "#b3588e" -- brown
