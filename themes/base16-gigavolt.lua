...
local base06 = "#eff0f9" -- +++
local base07 = "#f2fbff" -- ++++
local base08 = "#ff661a" -- red
local base09 = "#19f988" -- orange
local base0A = "#ffdc2d" -- yellow
local base0B = "#f2e6a9" -- green
local base0C = "#fb6acb" -- aqua/cyan
local base0D = "#40bfff" -- blue
local base0E = "#ae94f9" -- purple
local base0F = "#6187ff" -- brown
