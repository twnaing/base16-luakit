...
local base06 = "#959DCB" -- +++
local base07 = "#FFFFFF" -- ++++
local base08 = "#F07178" -- red
local base09 = "#F78C6C" -- orange
local base0A = "#FFCB6B" -- yellow
local base0B = "#C3E88D" -- green
local base0C = "#89DDFF" -- aqua/cyan
local base0D = "#82AAFF" -- blue
local base0E = "#C792EA" -- purple
local base0F = "#FF5370" -- brown
