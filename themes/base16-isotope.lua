...
local base06 = "#e0e0e0" -- +++
local base07 = "#ffffff" -- ++++
local base08 = "#ff0000" -- red
local base09 = "#ff9900" -- orange
local base0A = "#ff0099" -- yellow
local base0B = "#33ff00" -- green
local base0C = "#00ffff" -- aqua/cyan
local base0D = "#0066ff" -- blue
local base0E = "#cc00ff" -- purple
local base0F = "#3300ff" -- brown
