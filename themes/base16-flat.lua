...
local base06 = "#f5f5f5" -- +++
local base07 = "#ECF0F1" -- ++++
local base08 = "#E74C3C" -- red
local base09 = "#E67E22" -- orange
local base0A = "#F1C40F" -- yellow
local base0B = "#2ECC71" -- green
local base0C = "#1ABC9C" -- aqua/cyan
local base0D = "#3498DB" -- blue
local base0E = "#9B59B6" -- purple
local base0F = "#be643c" -- brown
