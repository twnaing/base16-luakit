...
local base06 = "#474545" -- +++
local base07 = "#2d2c2c" -- ++++
local base08 = "#fe3e31" -- red
local base09 = "#fe6d08" -- orange
local base0A = "#f7e203" -- yellow
local base0B = "#47f74c" -- green
local base0C = "#0f9cfd" -- aqua/cyan
local base0D = "#2931df" -- blue
local base0E = "#611fce" -- purple
local base0F = "#b16f40" -- brown
